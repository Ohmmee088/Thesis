...
void pnkey_open() {                 //กดปุ่มคีย์เพื่อเลือกเปิดประตู
  /**Serial.println("\nScan KEYPAD\n");
...
void pn535(){
  ...
  if (success) {
    ...
    if ((uid[0] == 3 || uid[1] == 247 || uid[2] == 170 || uid[3] == 21) ||  (uid[0] == 211 || uid[1] == 94 || uid[2] == 161 || uid[3] == 14))// *** uid คือข้อมูลเลขฐานของการ์ดหรือแท็ก ซึ่งการ์ดและแท็กแต่ละชิ้นก็จะมี uid ที่แตกต่างกัน ***// *** ผู้ใช้งานสามารถหา uid แต่ละตำแหน่งได้จากการใช้โมดูล PN532 อ่านข้อมูลของการ์ดหรือแท็ก ***
    {
