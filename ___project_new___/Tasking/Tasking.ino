...
void keypad_key(){     //ฟังชั้นนอก
  static unsigned long time = millis();   //เพิ่ม static
...
void setup()
{
  ...
  xTaskCreatePinnedToCore(loop_T0,"Task0",1000,NULL,0,&Task0,0); 
  xTaskCreatePinnedToCore(loop_T1,"Task1",1000,NULL,0,&Task1,1); 
  //xTaskCreatePinnedToCore(
  //    loop_T1, /* Function to implement the task */
