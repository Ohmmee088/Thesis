...
if (WiFi.status() == WL_CONNECTED) {             //http mysql
      ...
      url += "&rubbish_1=";     url +=  distances0;
      url += "&rubbish_2=";     url +=  distances1;
      url += "&rubbish_3=";     url +=  distances2;
      url += "&rubbish_4=";     url +=  distances3;
      url += "&rubbish_5=";     url +=  distances4;
      url += "&rubbish_6=";     url +=  distances5;
      url += "&rubbish_7=";     url +=  distances6;
      url += "&rubbish_8=";     url +=  distances7;
      Serial.println(url);
      http.begin(url);              //HTTP
