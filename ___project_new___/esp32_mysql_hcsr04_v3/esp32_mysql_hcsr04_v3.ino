...
for (int i = 0; i < 8; i++) {
    ...
    } else if ((distances[i] > 100) && hc[i] == 1) {
        hc[i] = 0;
...
if (WiFi.status() == WL_CONNECTED) {             //http mysql
      ...
      url += "&rubbish_1=";     url +=  hc0;
      url += "&rubbish_2=";     url +=  hc1;
      url += "&rubbish_3=";     url +=  hc2;
      url += "&rubbish_4=";     url +=  hc3;
      url += "&rubbish_5=";     url +=  hc4;
      url += "&rubbish_6=";     url +=  hc5;
      url += "&rubbish_7=";     url +=  hc6;
      url += "&rubbish_8=";     url +=  hc7;
      Serial.println(url);
      http.begin(url);              //HTTP
